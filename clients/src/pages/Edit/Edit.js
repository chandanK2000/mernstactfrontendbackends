...
import { userData } from '../../components/context/contexProvider';
const Edit = () => {
  ...
  const SubmitUserData = async (e) => {
    ...
    if (firstname === "") {
      ...
      data.append("user_profile", images || imagedata)
        ...
        showspin ? <Spiner /> : <div className='container'>
          ...
          <Card className="shadow mt-3 p-3">
            <div className='profile_div text-center'>
              <img src={images ? preview : `${BASE_URL}/uploads/${imagedata}`} alt="Description" />
            </div>
            <Form onSubmit={SubmitUserData} onKeyPress={(e) => {
              ...
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Form.Control type="number" name="mobile" value={inputdata.mobile} placeholder='Enter mobile number ' onChange={setInputvalue} />
                </Form.Group>
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Form.Control type="file" name="user_profile" placeholder='Enter email ' onChange={SetProfile} />
                </Form.Group>
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
